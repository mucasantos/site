//Lista começa com [ e temina com ]

// A lista abaixo, é uma lista de objetos!
var rickData = [
  {
    id: 1,
    name: "Rick Sanchez",
...
//Desafio 01
// Mostrar no console todos os nomes da lista.
const minhaMain = document.getElementById("main");
function mostrar() {

  for (let index = 0; index < rickData.length; index++) {
  //Criei o elemento
    var minhaDiv = document.createElement("div");
    minhaDiv.classList.add("flip-card");

    minhaDiv.innerHTML =   `

  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="${rickData[index].image}" alt="Avatar" style="width:300px;height:300px;">
    </div>
    <div class="flip-card-back">
      <h1>${rickData[index].name}</h1>
      <p>${rickData[index].species}</p>
      <p>${rickData[index].status}</p>
      <p>${rickData[index].gender}</p>
    </div>
  </div>
`;
